...
const navigation = [
  ...
  //   {
  //     name: 'YouTube',
  //     href: 'http://www.youtube.com/@Favecomp',
  //     icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
  //       <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
  //         <path
  //           fillRule='evenodd'
  ...
  {
    name: 'Follow on X',
    href: 'https://x.com/emekafavi2019',
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
      <svg fill='currentColor' viewBox='0 0 24 24' {...props}>
  ...
  },
  {
    ...
    href: 'https://www.linkedin.com/in/emeka-ezeamaka-246556227/',
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
  ...
  {
    name: 'Follow on Stack Overflow',
    href: 'https://stackoverflow.com/users/28801641/favurr',
    icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
      <svg fill='currentColor' viewBox='0 0 57 57' {...props}>
        <path
          fillRule='evenodd'
  ...
  //   {
  //     name: 'emekafavi2019@gmail.com',
  //     href: 'mailto:emekafavi2019@gmail.com',
  //     icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
...
export default function CSocials() {
  return (
    <div className='flex-none lg:flex-1'>
      {navigation.map(item => (
        <a
          ...
          className='text-muted-foreground transition-colors delay-150 duration-300 hover:text-foreground'
        >
          <div className='flex gap-4 pb-4 md:order-2'>
      ...
      <div className='my-6 hidden h-[1px] w-full rounded-full bg-gradient-to-r from-transparent via-muted-foreground to-transparent lg:block' />
      <a
        href='mailto:emekafavi2019@gmail.com'
        className='text-muted-foreground transition-colors delay-150 duration-300 hover:text-foreground'
      >
        <div className='flex gap-4 pb-4 md:order-2'>
          ...
          <p className='hidden md:block lg:block'>emekafavi2019@gmail.com</p>
        </div>
      </a>
    </div>
  )
